...
export default function Comtrade() {
    /*
     * ============================================================
     * ESTADOS
     * ============================================================
    ...
    const carregarResumo = useCallback(async () => {
        try {
            const response = await fetch("/api/v1/comtrade/resumo", {
                method: "GET",
                headers: {
                    "Accept": "application/json",
                    "X-Requested-With": "XMLHttpRequest"
    ...
    const carregarRegistros = useCallback(async () => {
        try {
            ...
            const response = await fetch(
                `/api/v1/comtrade?${params.toString()}`,
                {
                    method: "GET",
                    headers: {
                        "Accept": "application/json",
            ...
            console.error("Erro ao carregar registros COMTRADE:", err);
            setError(err.message || "Erro ao carregar registros COMTRADE.");
            setRecords([]);
        } finally {
            setLoading(false);
        }
        ...
        <LayoutAdmin>
            <div className="container-fluid py-4">
                ...
                <div className="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h2 className="mb-1">COMTRADE</h2>
                        <div className="text-muted">
                            Registros de oscilografia e perturbações
                        </div>
                    </div>
                    <button
                        type="button"
                            ...
                            <div className="card-body">
                                <div className="d-flex justify-content-between">
                                    <div>
                                        ...
                                        <div className="fs-3 fw-bold">{summary.total || 0}</div>
                    ...
                    <div className="col-12 col-sm-6 col-xl-4">
                        <div className="card border-0 shadow-sm h-100" style={{ borderLeft: "4px solid #198754" }}>
                            <div className="card-body">
                                <div className="d-flex justify-content-between">
                                    <div>
                                        <div className="text-muted small mb-1">Disponíveis</div>
                                        <div className="fs-3 fw-bold text-success">{summary.available || 0}</div>
                                        <div className="text-muted small">Prontos para análise</div>
                                    </div>
                    ...
                    <div className="col-12 col-sm-6 col-xl-4">
                        <div className="card border-0 shadow-sm h-100" style={{ borderLeft: "4px solid #dc3545" }}>
                            <div className="card-body">
                                <div className="d-flex justify-content-between">
                                    <div>
                                        <div className="text-muted small mb-1">Faltas</div>
                                        <div className="fs-3 fw-bold text-danger">{summary.faults || 0}</div>
                                        <div className="text-muted small">Registros de proteção</div>
                                    </div>
                    ...
                    <div className="card-header bg-white border-0 py-3">
                        <div className="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <div className="text-muted small">Localize registros COMTRADE</div>
                            </div>
                        </div>
                    </div>
                    <div className="card-body">
                ...
                <div className="card border-0 shadow-sm">
                    <div className="card-header bg-white border-0 py-3">
                        <div className="d-flex justify-content-between align-items-center">
                            <div>
                                <div className="fw-semibold">Registros COMTRADE</div>
                                <div className="text-muted small">
                                    {pagination.total} registros encontrados
                                </div>
                            </div>
                            <Icon path={mdiFileChartOutline} size={1.1} className="text-primary" />
                        </div>
                    </div>
                        ...
                        <table className="table table-hover align-middle mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th>Estação</th>
                                    <th>Disparo</th>
                                    <th className="text-end">Canais</th>
                                    <th className="text-end">Amostragem</th>
                                    <th>Status</th>
                                ...
                                {loading ? (
                                    <tr>
                                        <td colSpan="8" className="text-center py-5">
                                            ...
                                            <div className="mt-2 text-muted">Carregando registros...</div>
                                        </td>
                                    </tr>
                                ) : records.length === 0 ? (
                                    <tr>
                                        <td colSpan="8" className="text-center text-muted py-5">
                                            <Icon path={mdiWaveform} size={1.8} className="mb-2" />
                                            <div>Nenhum registro COMTRADE encontrado</div>
                                        </td>
                                    </tr>
                                ) : (
                                    records.map((record) => {
                                            ...
                                            <tr key={record.id}>
                                                <td>
                                                    ...
                                                    <div className="small text-muted d-flex align-items-center">
                                                        <Icon path={mdiClockOutline} size={0.65} className="me-1" />
                                                        {dt.time}
                                                    </div>
                                                </td>
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <div className="fw-semibold">
                                                                {record.ied_name || record.ied_id || "—"}
                                                            </div>
                                                            <div className="small text-muted">{record.ied_id}</div>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div className="fw-semibold">{record.station_name || "—"}</div>
                                                    <div className="small text-muted">{record.device_id || "—"}</div>
                                                </td>
                                                <td>
                                                    <div className="fw-semibold">{record.trigger_reason || "—"}</div>
                                                </td>
                                                <td className="text-end">
                                                    <div>{record.analog_channels || 0} analógicos</div>
                                                    <div className="small text-muted">{record.digital_channels || 0} digitais</div>
                                                </td>
                                                <td className="text-end">
                                                    {formatNumber(record.sample_rate, 0)} Hz
                                                </td>
                                                <td>
                                                    <span className={`badge ${status.className} d-flex align-items-center`}>
                    ...
                    {pagination.last_page > 1 && (
                        <div className="card-footer bg-white">
                            <div className="d-flex flex-wrap justify-content-between align-items-center gap-3">
                                <div className="text-muted small">
                                    Exibindo {pagination.from} até {pagination.to} de {pagination.total}
                                </div>
                                <nav>
                                    <ul className="pagination pagination-sm mb-0">
                                        ...
                                        <li className={`page-item ${page >= pagination.last_page ? "disabled" : ""}`}>
                                            <button className="page-link" disabled={page >= pagination.last_page} onClick={() => setPage(page + 1)}>
                                                Próximo
                                            </button>
                                        </li>
                                    </ul>
